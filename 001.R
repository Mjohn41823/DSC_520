...
week1_sleep_weekdays <- week1_sleep[1:2]
...
grades <- cbind(c(92.1,84.3,75.1,97.8))
...
factor_genre_vector <- c("Fantasy", "Sci-fi","Mystery")
...
sorted_characters_df <- characters_df[order(age,na.last=TRUE),]
